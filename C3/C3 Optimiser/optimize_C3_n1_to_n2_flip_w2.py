...
def fidelity_simulation_C3_weights(fixed_initial_edge_weights, initial_runtime_before,
    ...
    In this version, the initial edge weights are [w1, w2, w3], and final edge weights are [w1, -w2, w3].
    ...
    for step in range(500000):
        with tf.GradientTape() as tape:
            ...
            final_weights = [w1, -w2, w3]  # Final Hamiltonian weights after flipping w2
    ...
    pd.DataFrame(solutions).to_csv("solutions_n1_to_n2_C3_1_-w2_w3_0.999999999999.csv", index=False)

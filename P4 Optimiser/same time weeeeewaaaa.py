...
def fidelity_simulation_P4_symmetric_weights(fixed_initial_edge_weights, initial_runtime_before,
                                             ...
                                             stagnation_threshold=0.1, stagnation_window=2000):
    """
...
initial_runtime_before = 10.0  # Initial runtime before the state transfer
initial_runtime_after = 10.0   # Initial runtime after the state transfer
